  ...
  module DTO
    class Team < ::LeagueOfLegends::DTO::Base
      ...
      attr_reader :create_date, :full_id, :last_game_date, :last_join_date,
                  ...
                  :message_of_day, :modify_date, :name, :roster,
                  :second_last_join_date, :status, :tag, :team_stat_summary,
      ...
      def initialize(attributes)
        ...
        @message_of_day = ::LeagueOfLegends::DTO::MessageOfDay
          .new(attributes[:messageOfDay])
        ...
        @tag = attributes[:tag]
        @team_stat_summary = ::LeagueOfLegends::DTO::TeamStatSummary
          .new(attributes[:teamStatSummary])
