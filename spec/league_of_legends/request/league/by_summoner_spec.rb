...
describe ::LeagueOfLegends::Request::League::BySummoner do
  ...
  it "has the required parameters" do
    expect(described_class.dto_class).to eq ::LeagueOfLegends::DTO::LeagueList
  ...
  it "can be sent and get a response" do
    VCR.use_cassette('league by_summoner') do
      expect(request.response).to be_an_instance_of ::LeagueOfLegends::DTO::LeagueList
    end
  end
